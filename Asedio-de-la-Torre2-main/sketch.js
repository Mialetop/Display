...
function setup() {
  ...
  Engine.run(engine);
  ground = new Ground();
  stand1 = new Stand(displayWidth/3,300,250,10);
  stand2 = new Stand(displayWidth/3*2,200,200,10);
  ...
  slingShot = new SlingShot(this.polygon,{x:this.displayHeight/10,y:this.displayWidth/2-500});
